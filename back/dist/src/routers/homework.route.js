...
const update_home_work_1 = require("../controllers/homework/update-home-work");
const router = (0, express_1.Router)();
exports.homeworkRouter = router;
// Protected routes (authentication required)
router.post("/", homework_1.submitHomework);
...
router.put("/update/:id", update_home_work_1.updateHomeworkById);
