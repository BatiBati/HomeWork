...
const update_techer_1 = require("../controllers/teacher/update-techer");
...
router.get("/me", auth_techer_middlware_1.authMiddleware, getMe_teacher_1.getMe);
router.get("/:id", teacher_1.getTeacherById);
router.put("/:id", update_techer_1.updateTeacher);
