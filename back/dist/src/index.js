...
const children_route_1 = require("./routers/children.route");
const message_route_1 = require("./routers/message.route");
const assignment_route_1 = require("./routers/assignment.route");
const daycare_route_1 = require("./routers/daycare.route");
const getMe_route_1 = require("./routers/getMe.route");
(0, dotenv_1.config)();
