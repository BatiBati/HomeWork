  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-5xl w-full mt-15">
        <div className="p-6 rounded-2xl hover:shadow-lg transition cursor-pointer bg-gradient-to-br from-yellow-50 to-orange-100">
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            🍎 Багшаар нэвтрэх
          </h2>
          <div
            className="w-full h-60 bg-white rounded-xl flex items-center justify-center text-6xl "
